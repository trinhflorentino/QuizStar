    ...
    _0x3e3948.onSnapshot(_0x2b2bae => {
      ...
      _0x44872e.orderByChild('uid').equalTo(_0x58b1d6.uid).on("value", function (_0x1883b3) {
        ...
        if (_0x1883b3.exists()) {
          ...
          if (_0x166cf6 === 0x0) {
            failToast("Yêu cầu xem trận đấu của bạn đang chờ duyêt. Không được tham gia bằng cách vào URL.");
            ...
            if (_0x166cf6 === 0x2) {
              failToast("Bạn đã bị từ chối xem trận đấu này.");
              document.body.style.pointerEvents = "none";
              setTimeout(() => {
                location.replace("Main.html");
              }, 0xbb8);
          ...
          failToast("Bạn không có quyền xem trận đấu này.");
          document.body.style.pointerEvents = "none";
          setTimeout(() => {
            location.replace("Main.html");
          }, 0xbb8);
