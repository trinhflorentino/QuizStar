      ...
      firebase.firestore().collection("hostUids").doc(auth.currentUser.uid).get().then(_0x5cb626 => {
        if (_0x5cb626.exists) {
          ...
          if (_0x3e5ac6 && _0x1b37a6.seconds > _0x3e5ac6.seconds || _0x396272 !== null) {
            failToast("Bạn không có quyền điều khiển phòng trò chơi, bị vô hiệu hoá hoặc đã hết hạn sử dụng dịch vụ. Đang điều hướng bạn về trang chủ.", 0x1388, "top", 'right', true, false, '');
