...
function uploadGeneralInfo() {
    ...
    Notification("Cập nhật tên trận đấu thành công")
}
...
function DeleteTournament() {
    if (confirm("Bạn có chắc chắn muốn xoá trận/giải đấu không? Thao tác này không thể hoàn tác! / Lưu ý: Vui lòng tắt tab Điều khiển trận đấu trước khi thực hiện lệnh này") == true) {
