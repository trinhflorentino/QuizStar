        ...
        const updateObstacleRows = rowData => {
          ...
          for (let i = 0x1; i <= 0x4; i++) {
            ...
            for (let char of rowAnswer) {
              ...
              charDiv.className = rowStatus === 0x2 ? "w-12 h-12 bg-red-300  rounded-full flex items-center justify-center border-4 border-white" : "w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center border-4 border-white";
              const charSpan = document.createElement("span");
              charSpan.className = "text-xl font-bold text-black";
