...
const ResultSummary: React.FC = () => {
  ...
  const { score = 0, totalScore = 0, questionResults = [] } = (location.state as LocationState) || {};
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-3 sm:p-4 md:p-6">
      <div className="max-w-2xl w-full bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between">
          ...
          <button
            onClick={() => {
              if (pin && studentEmail && attemptId) {
                navigate(`/pinverify/Form/${pin}/ResultFetch/${studentEmail}/${attemptId}`);
              }
            }}
