...
const Sidebar = ({ onBackClick }) => {
  return (
    <aside className="fixed top-0 left-0 z-40 w-32 h-screen transition-transform -translate-x-full sm:translate-x-0 border-r-2 border-neutral-100 dark:border-gray-500 flex flex-col justify-between items-center">
      {/* App Logo */}
      <div className="mt-6">
        <img id="appLogoImage" src="img/appLogo.png" className="rounded-full w-16 h-16 cursor-default" alt="appLogo" />
      </div>
      ...
      <div className="mb-4">
        <button data-tab-target="#profile" className="tab-button">
          <img src="img/userAvatar.png" alt="avatar" 
...
const NavButton = ({ icon, tooltip, target }) => (
  <div className="my-4">
