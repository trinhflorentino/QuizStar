...
firebase.database().ref(matchid + '/chat').on('value', function (snapshot) {
    msgs.innerHTML = '';
    msgs.innerHTML += '<div class="chat-msg-admin"><p>HỆ THỐNG: Theo dõi <a style="color:white">QuizStar</a> tại: <a style="cursor:pointer;color: inherit;" href="https://www.facebook.com/theolympusonline" target="_blank">https://www.facebook.com/theolympusonline</a></p></div>';
